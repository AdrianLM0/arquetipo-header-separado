      ...
      "secciones": [{
              ...
              "subSecciones": [{
                      ...
                      "columnas": [{
                              ...
                              "enlace": "/temas/estudiar/becas.html",
                              "seccion": "Transparencia",
                              "id": "iconos_Transparencia_subseccion11",
                              "image": "",
                              "textoImage": "",
                              "descripcionSeccion": "",
                              "enlaceVerMas": "",
                              ...
                              "titulo": "Conoce más sobre la transparencia",
                              "enlace": "/temas/estudiar/centros.html",
                              "seccion": "Transparencia",
                              "id": "iconos_Transparencia_subseccion12",
                              "image": "",
                              "textoImage": "",
                              "descripcionSeccion": "",
                              "enlaceVerMas": "",
...
opcionesAdministrador: {
	...
	inputValidation() {
		if (this.typeStyle !== 'matter' && this.typeStyle !== 'material') {
			console.log(
	...
	mostrarDesplegable(event: Event) {
		...
		const lista_desplegable =
			desplegable.parentElement.querySelector('lib-fomento-menu').classList;
