...
export class EjemploFomentoChipsComponent {
	...
	chips = [
        ...
        { id: '2', label: 'Chip 2', value: '2', color: 'accent' as ThemePalette, selected: true, disabled: true, ariaLabel: 'Botón chip 2', ariaDescrption: 'Boton chip deshabilitado con valor 2'},
